...
// Initializer
func (p *SubscribeOrderWebSocketV2Client) Init(gatewayHost string, accessKey string, secretKey string, host string) *SubscribeOrderWebSocketV2Client {
	p.WebSocketV2ClientBase.Init(gatewayHost, accessKey, secretKey, host)
	return p
}
